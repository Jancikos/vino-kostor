...
// ===== chartOne
const chartRevenue = () => {
    const chartWrapper = $("#chart_revenue");
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            chartOptions.xaxis.categories = data.xAxis.categories;
            chartOptions.yaxis.max = data.yAxis.max;
            chartOptions.yaxis.min = data.yAxis.min;
        
            // zobraz graf
            const chartSelector = document.querySelectorAll("#chart-revenue");
