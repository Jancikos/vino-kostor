...
class UserTableMap extends TableMap
{
     ...
     */
    public const OM_CLASS = '\\App\\Model\\User';
     ...
     */
    public const COL_ROLES = 'user.ROLES';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Pk', 'Username', 'Password', 'Roles', ],
        self::TYPE_CAMELNAME     => ['pk', 'username', 'password', 'roles', ],
        self::TYPE_COLNAME       => [UserTableMap::COL_PK_, UserTableMap::COL_USERNAME, UserTableMap::COL_PASSWORD, UserTableMap::COL_ROLES, ],
        self::TYPE_FIELDNAME     => ['PK_', 'USERNAME', 'PASSWORD', 'ROLES', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Pk' => 0, 'Username' => 1, 'Password' => 2, 'Roles' => 3, ],
        self::TYPE_CAMELNAME     => ['pk' => 0, 'username' => 1, 'password' => 2, 'roles' => 3, ],
        self::TYPE_COLNAME       => [UserTableMap::COL_PK_ => 0, UserTableMap::COL_USERNAME => 1, UserTableMap::COL_PASSWORD => 2, UserTableMap::COL_ROLES => 3, ],
        self::TYPE_FIELDNAME     => ['PK_' => 0, 'USERNAME' => 1, 'PASSWORD' => 2, 'ROLES' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
    ...
    {
        $this->addRelation('Order', '\\App\\Model\\Order', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':USER_PK_',
    1 => ':PK_',
    ...
    {
        return [
            'validate' => ['rule1' => ['column' => 'username', 'validator' => 'NotNull'], 'rule2' => ['column' => 'username', 'validator' => 'Length', 'options' => ['max' => 100, 'min' => 2]]],
        ];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(UserTableMap::COL_PK_);
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn($alias . '.ROLES');
        }
    }
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(UserTableMap::COL_PK_, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ?ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(UserTableMap::COL_PK_) && $criteria->keyContainsValue(UserTableMap::COL_PK_) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.UserTableMap::COL_PK_.')');
        }
