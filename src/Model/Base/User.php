...
abstract class User implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\App\\Model\\Map\\UserTableMap';
    ...
    public function setPk($v)
    {
        ...
        if ($this->pk_ !== $v) {
            $this->pk_ = $v;
            $this->modifiedColumns[UserTableMap::COL_PK_] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UserTableMap::translateFieldName('Pk', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_PK_)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_PK_)) {
            $criteria->add(UserTableMap::COL_PK_, $this->pk_);
        }
        if ($this->isColumnModified(UserTableMap::COL_USERNAME)) {
    ...
    static public function loadValidatorMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->addPropertyConstraint('username', new Length(array ('max' => 100,'min' => 2,)));
    }
